#ifndef CONVERT_RANDOM_MESSAGE_FIELD_NODE_HPP
#define CONVERT_RANDOM_MESSAGE_FIELD_NODE_HPP
...
namespace BT_ROS
{
class ConvertRandomMessageFieldNode final : public BT::SyncActionNode
{
    public:
        using BT::SyncActionNode::SyncActionNode;
        ~ConvertRandomMessageFieldNode() = default;
        ...
        virtual BT::NodeStatus tick() override
        {
            ...
            try
            {
                ...
                deserialization::deserializeField(*this, "output", *random_it);
